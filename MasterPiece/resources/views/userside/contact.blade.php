        ...
        <div class="col-lg-4">
            <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                ...
                <div class="ps-4">
                    ...
                    <h4 class="text-primary mb-0">+962 777 777 777</h4>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
    ...
    <div class="row g-5">
        <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
            <form action="{{route('contactsend')}}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <textarea class="form-control border-0 bg-light px-4 py-3" rows="4" name="msg" placeholder="Message" required></textarea>
                    </div>
                    <div class="col-12">
        ...
        <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
            <iframe class="position-relative rounded w-100 h-100"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d222065.9846862741!2d34.935050098827645!3d29.58097437955424!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15007039ff2efa81%3A0x595faa556d2e6acc!2sAqaba!5e0!3m2!1sen!2sjo!4v1656213503426!5m2!1sen!2sjo"
